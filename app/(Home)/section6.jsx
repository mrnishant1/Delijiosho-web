...
//   return (
//     <div className="grid grid-rows-3 grid-cols-3 w-full text-lg justify-between font-serif text-gray-300 items-start px-10">
//             {/* Quick Links */}
//             <div className="max-w-[30%] flex flex-col gap-4 pl-5">
...
//             {/* About Us */}
//             <div className="max-w-[40%] pr-5 text-justify">
...
//             {/* Newsletter & Feedback */}
//             <div className="max-w-[30%] flex flex-col gap-6 pl-5">
//                     {/* Business Contact */}
//                     <div>
